...
class Jugador:
    ...
    def __str__(self):
        return self.__nombre + " || tipo de ficha: " + self.__tipo_ficha + " || puntuacion: " + str(self.__puntuacion)
...
class Tablero:
    ...
    def hay_tres_en_raya(self):
        ...
        for posible in posibles:
            ...
            if (fichas[0] == fichas[1] and fichas[1] == fichas[2] and fichas[1] != " "):  
              # hay 3 en hay_tres_en_raya
...
class Partida:
    ...
    def jugar_partida(self):
        while (not(self.__partida_terminada) and not(self.__tablero.hay_tres_en_raya()) and not(self.__tablero.esta_lleno())):
            if(self.__tablero.esta_lleno()):
                print("El juego queda en tablas")
            else:
